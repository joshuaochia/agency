...
const CounterSection = () => {
  ...
  return (
    <section
      ...
      className="counter_section section_space_lg decoration_wrap"
    >
      <div className="container">
        {factList && (
          <div className="row">
            {factList.map((item) => (
              <div
                className="col col-lg-4 col-md-6"
              ...
              >
                <div className="counter_item mb-5 mb-lg-0">
                  <div className="counter_value d-flex justify-content-center">
                    <Counter number={item.factNumber}></Counter>
                    <span
                      className="odometer"
                      data-count={item.data_count}
                    ></span>
      ...
      <div className="deco_item shape_1">
        <img
          src="assets/images/shapes/shape_line_flow.svg"
          alt="Paradox Shapes Image Line Flow"
        />
      </div>
      <div className="deco_item shape_2">
        <img
          src="assets/images/shapes/shape_circle_2.svg"
          alt="Paradox Shapes Circle"
        />
      </div>
    </section>
  );
